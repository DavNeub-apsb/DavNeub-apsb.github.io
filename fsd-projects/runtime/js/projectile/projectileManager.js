(function (window) {
    ...
    window.opspark.makeProjectileManager = function (view, space, particleManager) {
        ...
        function makeProjectile() {
            var projectile = _.extend(draw.circle(5, '#3cff06ff'), physikz.makeBody('projectile'));
        ...
        _projectileManager = {
            fire: function (emitter) {
                ...
                createjs.Tween.get(projectile, {override: true}).wait(500).to({alpha: 0, scaleX: 0.1, scaleY: 0.1}, 400, createjs.Ease.linear).call(onTweenComplete);
